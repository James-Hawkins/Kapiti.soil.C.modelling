@echo off
set "inputFile=KE_Kapiti_soilchemistry-daily.txt"
set "inputFile2=KE_Kapiti_physiology-daily.txt"
set "inputFile3=KE_Kapiti_watercycle-daily.txt"


set "outputFile=KE_Kapiti_soilchemistry-daily.csv"
set "outputFile2=KE_Kapiti_physiology-daily.csv"
set "outputFile3=KE_Kapiti_watercycle-daily.csv"
