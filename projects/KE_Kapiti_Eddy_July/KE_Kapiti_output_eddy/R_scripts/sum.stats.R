...
# Hydrological means across periods
summary(d.all[d.all$period == 'drought' ,'r.a.swc.15.30d.cm.osv'])
summary(d.all[d.all$period == 'pluvial' ,'r.a.swc.15.30d.cm.osv'])
summary(d.all[d.all$period == 'normal' ,'r.a.swc.15.30d.cm.osv'])

summary(d.all[d.all$period == 'drought' ,'precip.osv'])
summary(d.all[d.all$period == 'dipole' ,'precip.osv'])
summary(d.all[d.all$period == 'normal' ,'precip.osv'])
