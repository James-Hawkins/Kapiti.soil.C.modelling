...
#d.physio$ag.biom.grass.kg.m2 <- d.physio.all[ d.physio.all$species %in% unique.species.grass     ,   'ag.biom.kg.m2' ] #+ d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'ag.biom.kg.m2' ] +  d.physio.all[ d.physio.all$species == unique.species.grass[3]     ,   'ag.biom.kg.m2' ]

#d.physio$ag.biom.grass.1.kg.m2 <- d.physio.all[ d.physio.all$species == unique.species.grass[1]     ,   'ag.biom.kg.m2' ] #+ d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'ag.biom.kg.m2' ] +  d.physio.all[ d.physio.all$species == unique.species.grass[3]     ,   'ag.biom.kg.m2' ]
#d.physio$ag.biom.grass.2.kg.m2 <- d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'ag.biom.kg.m2' ] #+ d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'ag.biom.kg.m2' ] +  d.physio.all[ d.physio.all$species == unique.species.grass[3]     ,   'ag.biom.kg.m2' ]

#d.physio$bg.biom.grass.1.kg.m2 <- d.physio.all[ d.physio.all$species == unique.species.grass[1]     ,   'bg.biom.kg.m2' ] #+ d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'ag.biom.kg.m2' ] +  d.physio.all[ d.physio.all$species == unique.species.grass[3]     ,   'ag.biom.kg.m2' ]
#d.physio$bg.biom.grass.2.kg.m2 <- d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'bg.biom.kg.m2' ] #+ d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'ag.biom.kg.m2' ] +  d.physio.all[ d.physio.all$species == unique.species.grass[3]     ,   'ag.biom.kg.m2' ]


#d.physio$bg.biom.grass.kg.m2 <- d.physio.all[ d.physio.all$species %in% unique.species.grass    ,   'bg.biom.kg.m2' ] #+ d.physio.all[ d.physio.all$species == unique.species.grass[2]     ,   'bg.biom.kg.m2' ] + d.physio.all[ d.physio.all$species == unique.species.grass[3]     ,   'bg.biom.kg.m2' ]
...
# Biomass data
{
  ...
  ect.biomass$Date <- substr( ect.biomass$Date , 1 ,  10)
  ect.biomass$Date <- as.Date(ect.biomass$Date , format = "%Y-%m-%d" )
  
  ect.biomass <- ect.biomass[ !is.na(ect.biomass$Date)  ,]
  
  ect.biomass <- ect.biomass[!duplicated(ect.biomass), ]
  
  nrow(ect.biomass)
  
  unique.cages <- unique(ect.biomass$cage.ID)
  ...
  for (d in 1 : nrow(ect.biomass)  ){
    ...
    series.labl <- str_c(  'osv.biom.kg.ha.' , c.cage )
...
bias.cond.swc <- biases.long$osv.variable == 'r.a.swc.osv' 
...
# SWC
mean(d.all[d.all$period == period.dipole , 'r.a.swc.sim.bc']) - mean(d.all[d.all$period == period.dipole, 'r.a.swc.sim']) 
mean(d.all[d.all$period == period.drought , 'r.a.swc.sim.bc']) - mean(d.all[d.all$period == period.drought, 'r.a.swc.sim']) 
mean(d.all[d.all$period == period.normal , 'r.a.swc.sim.bc']) - mean(d.all[d.all$period == period.normal, 'r.a.swc.sim']) 

sd(d.all[d.all$period == period.dipole , 'r.a.swc.sim.bc']) / sd(d.all[d.all$period == period.dipole, 'r.a.swc.sim']) 
sd(d.all[d.all$period == period.drought , 'r.a.swc.sim.bc']) /  sd(d.all[d.all$period == period.drought, 'r.a.swc.sim']) 
sd(d.all[d.all$period == period.normal , 'r.a.swc.sim.bc']) / sd(d.all[d.all$period == period.normal, 'r.a.swc.sim']) 
...
print(paste('nRMSE for SWC is' , nrmse.swc.all))
print(paste('nRMSE for TER is' , nrmse.ter.all))
print(paste('nRMSE for GPP is' , nrmse.gpp.all))
print(paste('nRMSE for NEE is' , nrmse.nee.all))
...
# Decomposition of biomass
{
  ...
  d.all$ag.biom.grass.kg.ha
  
  ag.biom.grass.kg.m2
  
  unique(d.all$osv.biom.kg.ha)
  

  
  d.all$osv.biom.kg.ha.
  
gg.bio.decomp <- ggplot( d.all ,   aes(x = date.time )  
) +  
  geom_line( aes(x = date, y = ag.biom.kg.ha /1000 , color=  "L-DNDC" ) 
             , linewidth = p.ln.width 
  ) +
  
  # 1
  geom_point( aes(x = date, y = osv.biom.kg.ha.LM1 , color =  "LM1" ) 
              # , linewidth = p.ln.width 
  ) +
  
  geom_point( aes(x = date, y = osv.biom.kg.ha.LS1 , color =  "LS1" ) 
              # , linewidth = p.ln.width 
  ) +
  
  # 2
  geom_point( aes(x = date, y = osv.biom.kg.ha.LM2 , color =  "LM2" ) 
            # , linewidth = p.ln.width 
  ) +
  
  geom_point( aes(x = date, y = osv.biom.kg.ha.LS2 , color =  "LS2" ) 
              # , linewidth = p.ln.width 
  ) +
  
  # 3
  geom_point( aes(x = date, y = osv.biom.kg.ha.LM3 , color =  "LM3" ) 
              # , linewidth = p.ln.width 
  ) +
  
  geom_point( aes(x = date, y = osv.biom.kg.ha.LS3 , color =  "LS3" ) 
              # , linewidth = p.ln.width 
  ) +
  
  # 3
  geom_point( aes(x = date, y = osv.biom.kg.ha.LM4 , color =  "LM4" ) 
              # , linewidth = p.ln.width 
  ) +
  
  geom_point( aes(x = date, y = osv.biom.kg.ha.LS4 , color =  "LS4" ) 
              # , linewidth = p.ln.width 
  ) +
...
gg.swc.no.labl <- gen.valid.plot( 'r.a.swc.osv'  , 'r.a.swc.sim'  , 'r.a.swc.sim.bc'   , gg.valid.swc.y.ax.lab , global.valid.gpp.y.cord.high , global.valid.gpp.y.cord.mid  , global.valid.gpp.y.cord.bottm ,'no.label' , TRUE)
gg.swc.labl <- gen.valid.plot( 'r.a.swc.osv'  , 'r.a.swc.sim'  , 'r.a.swc.sim.bc'   , gg.valid.swc.y.ax.lab , global.valid.gpp.y.cord.high , global.valid.gpp.y.cord.mid  , global.valid.gpp.y.cord.bottm ,'label', TRUE)
...
gg.lai.labl <- gen.valid.plot( 'r.a.swc.osv'  , 'r.a.swc.sim'  , 'r.a.swc.sim.bc'   , gg.valid.swc.y.ax.lab , global.valid.gpp.y.cord.high , global.valid.gpp.y.cord.mid  , global.valid.gpp.y.cord.bottm ,'label')
...
# Soil water content
{
  ...
  gg.valid.swc.no.labl <- gg.theme  %>%   +  
    ...
    geom_line( 
      data = d.all[ d.all.plot.conditions & d.all$covid != covid.status[3]  , ] ,
       aes(x = date, y = r.a.swc.osv , color= gg.valid.labels[2]  ) 
      , linewidth = p.ln.width  
    ) +
   # geom_line( 
     # data = d.all[ d.all.plot.conditions & d.all$covid != covid.status[3] , ] ,
     # aes(x = date, y = r.a.swc.sim.bc , color = 'bias.corrected'  ) 
      #, linewidth = p.ln.width  
   # ) +
    theme(
      plot.margin = margin( 
